...
const Page = () => {
  ...
  return (
    <main className="flex flex-col h-screen max-h-screen overflow-hidden">
      ...
      <div className="p-4 border-4 border-zinc-800 bg-zinc-900/30">
        <div className="flex gap-4">
          <div className="flex-1 relative group">
            ...
            <input
              ...
              autoFocus
              className="w-full bg-black border border-zinc-800 focus:border-zinc-700 focus:outline-none transition-colors text-zinc-100 placeholder:text-zinc-500 py-3 pl-8 pr-4 text-sm"
            />
          </div>
